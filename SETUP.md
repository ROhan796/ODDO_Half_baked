...
└──┬────┬────┬────┬────┬────┬────┬────┬────┬────┬───────────────┘
   │    │    │    │    │    │    │    │    │    │
   ▼    ▼    ▼    ▼    ▼    ▼    ▼    ▼    ▼    ▼
  DB  Redis  B2  Razorpay Digio Resend MSG91 Sentry Gemini
```
...
| Backblaze B2 | [BACKBLAZE_B2_SETUP.md](docs/setup/BACKBLAZE_B2_SETUP.md) | File storage (free 10GB) |
...
│   │   └── utils/           # DB, Redis, Storage, email, SMS, QR
...
- [ ] Backblaze B2 bucket created with CORS
