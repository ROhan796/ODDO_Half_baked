...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("user_type", sa.Enum(name="user_type_enum"), nullable=False, server_default="personal"),
        ...
        sa.Column("kyc_status", sa.Enum(name="kyc_status_enum"), server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("channel", sa.Enum(name="otp_channel_enum"), nullable=False),
        sa.Column("code", sa.String(6), nullable=False),
        sa.Column("purpose", sa.Enum(name="otp_purpose_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False),
        sa.Column("step", sa.Enum(name="kyc_step_enum"), nullable=False),
        ...
        sa.Column("status", sa.Enum(name="kyc_record_status_enum"), server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("legal_entity_type", sa.Enum(name="legal_entity_type_enum"), nullable=False),
        ...
        sa.Column("kyc_status", sa.Enum(name="enterprise_kyc_status_enum"), server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("sub_role", sa.Enum(name="enterprise_sub_role_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum(name="enterprise_credit_txn_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("trust_tier", sa.String(20), server_default="unverified"),
        sa.Column("status", sa.Enum(name="group_status_enum"), server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum(name="group_member_role_enum"), server_default="member"),
        sa.Column("status", sa.Enum(name="group_member_status_enum"), server_default="invited"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="group_deposit_status_enum"), server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("payment_status", sa.Enum(name="group_deposit_payment_status_enum"), server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("vote_type", sa.Enum(name="group_vote_type_enum"), nullable=False),
        sa.Column("requested_by", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("reason", sa.Text, nullable=True),
        sa.Column("status", sa.Enum(name="group_vote_status_enum"), server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("vote", sa.Enum(name="vote_choice_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="product_status_enum"), server_default="available"),
        ...
        sa.Column("late_fee_mode", sa.Enum(name="late_fee_mode_enum"), server_default="daily"),
    ...
    op.create_table(
        ...
        sa.Column("block_type", sa.Enum(name="block_type_enum"), nullable=False),
        sa.Column("rental_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("rentals.id"), nullable=True),
        sa.Column("start_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("end_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("status", sa.Enum(name="block_status_enum"), server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("enterprise_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("enterprises.id"), nullable=True),
        sa.Column("status", sa.Enum(name="quotation_status_enum"), server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="rental_status_enum"), server_default="pending"),
        sa.Column("rental_type", sa.Enum(name="rental_type_enum"), nullable=False),
        sa.Column("start_date", sa.Date, nullable=False),
        sa.Column("end_date", sa.Date, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="extension_status_enum"), server_default="pending"),
        sa.Column("requested_by", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("start_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("end_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("status", sa.Enum(name="reservation_status_enum"), server_default="pending"),
        sa.Column("expires_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("quotation_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("quotations.id"), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("enterprise_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("enterprises.id"), nullable=True),
        sa.Column("rental_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("rentals.id"), nullable=True),
        sa.Column("status", sa.Enum(name="invoice_status_enum"), server_default="draft"),
        sa.Column("subtotal", sa.Numeric(12, 2), nullable=False),
        sa.Column("tax_amount", sa.Numeric(12, 2), server_default="0"),
        sa.Column("discount_amount", sa.Numeric(12, 2), server_default="0"),
        sa.Column("total_amount", sa.Numeric(12, 2), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("customer_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("status", sa.Enum(name="payment_status_enum"), server_default="pending"),
        sa.Column("payment_method", sa.Enum(name="payment_method_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("customer_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("status", sa.Enum(name="deposit_status_enum"), server_default="pending"),
        sa.Column("authorization_code", sa.String(255), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("reason", sa.String(255), nullable=False),
        sa.Column("deduction_type", sa.Enum(name="deduction_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("product_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("products.id"), nullable=False),
        sa.Column("event_type", sa.Enum(name="custody_event_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="late_fee_status_enum"), server_default="calculated"),
    ...
    op.create_table(
        ...
        sa.Column("dispute_type", sa.Enum(name="dispute_type_enum"), nullable=False),
        ...
        sa.Column("status", sa.Enum(name="dispute_status_enum"), server_default="open"),
        sa.Column("resolution", sa.Enum(name="dispute_resolution_enum"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="repair_status_enum"), server_default="reported"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="recovery_status_enum"), server_default="initiated"),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("reason", sa.Enum(name="blacklist_reason_enum"), nullable=False),
        sa.Column("description", sa.Text, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("type", sa.Enum(name="notification_type_enum"), nullable=False),
        ...
        sa.Column("status", sa.Enum(name="notification_status_enum"), server_default="pending"),
        sa.Column("sent_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum(name="notification_template_type_enum"), nullable=False),
        sa.Column("channel", sa.Enum(name="notification_template_channel_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("contact_type", sa.Enum(name="crm_contact_type_enum"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("email", sa.String(255), nullable=True),
        sa.Column("phone", sa.String(15), nullable=True),
        sa.Column("company", sa.String(255), nullable=True),
        sa.Column("designation", sa.String(255), nullable=True),
        sa.Column("status", sa.Enum(name="crm_contact_status_enum"), server_default="new"),
    ...
    op.create_table(
        ...
        sa.Column("interaction_type", sa.Enum(name="crm_interaction_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("movement_type", sa.Enum(name="stock_movement_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("transaction_type", sa.Enum(name="points_transaction_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="referral_status_enum"), server_default="pending"),
